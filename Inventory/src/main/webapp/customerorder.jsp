		                                    	...
		                                    	<table id="orders" class="table table-striped table-bordered display no-wrap" style="width:100%">
		                                    		...
		                                    		<tbody>
		                                    			...
		                                    			<tr id="row<%=i%>">
		                                    				...
		                                    				<td >
		                                    					<a href="javascript:void(0)" onclick='removeRow(this)' name='remove' 
		                                    					title="delete" id="remove<%= i%>" class="btn btn-danger" >remove</a>
	    ...
	    $('document').ready(function(){
			...
			$('#addRow').click(function() {
	        	...
	        	let $newtr = $("<tr id='row"+counter+"'><td>"+counter+"</td><td><select id='' required class='form-control' name='idproduct[]'>"+
			        	...
			        	"<td><a onclick='removeRow(this)' href='javascript:void(0)' name='remove' title='supprimer' id='remove"+counter+"' class='btn btn-danger' >remove</a><input type='hidden' name='idorderitem[]'/></td></tr>" );
			...
			removeRow = function (e){
				...
				if(idorderitem == "")
				{
					...
					if(rep){
						$.ajax({
							url : "orderitem?action=delete&id="+idorderitem,
							type : "POST",
							cache : "false",
