                    ...
                    <div class="col-12">
                    	<div class="row">
		                    <div class="col-sm-12 offset-md-1 offset-lg-2 col-md-10 col-lg-8">
		                        <div class="card">
		                            <div class="card-body">
		                                <h4 class="card-title">Type Movement Stock Form</h4>
		                                <% Stock_movement stockmovement = (Stock_movement)request.getAttribute("stockmovement"); %>
		                                <form class="row" action="stockmovement" method="post">
		                                	<input type="hidden" name = "id" value = "<%= stockmovement.getId() > 0 ? stockmovement.getId():""%>" >
		                                	<input type="hidden" name="action" value="<%= stockmovement.getId() > 0 ? "update" : "create"%>">
		                                    <div class="form-group col-sm-12 col-md-6 col-lg-6">
		                                    	<label class="">Title </label>
		                                        <input required type="text" class="form-control" name="title" 
		                                        value="<%= stockmovement.getTitle() == null ? "": stockmovement.getTitle()%>" placeholder="Title">
