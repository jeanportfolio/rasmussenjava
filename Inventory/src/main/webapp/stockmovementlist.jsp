...
<head>
    ...
    <title>List Movement Nature</title>
    <!-- Custom CSS -->
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
			    ...
			    <% List<Stock_movement> liststockmovement = (List<Stock_movement>)request.getAttribute("liststockmovement");%>
			  		<% for(Stock_movement stockmovement : liststockmovement){ %>
			        <tr>
			            <td><%= stockmovement.getTitle() %></td>
			            <td>
			            	<a class="btn" href="stockmovement?action=update&id=<%= stockmovement.getId()%>">Edit</a>
			            </td>
			        </tr>
			    <% } %>
			    </tbody>
