    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
			    ...
			    <% List<Stockorder> liststockorder = (List<Stockorder>)request.getAttribute("liststockorder");%>
			  		<% for(Stockorder stockorder : liststockorder){ %>
			        <tr>
			            <td><%= stockorder.getStockordernumber() %></td>
			            <td><%= stockorder.getSuppliers().getSuppliersname()%></td>
			            <td><%= stockorder.getTotalamount() %></td>
			            <td><%= stockorder.getCreatedate()%></td>
			            <td>
			            	<a class="btn" href="stockorder?action=update&id=<%= stockorder.getId()%>">Edit</a>
			            </td>
			        </tr>
			    <% } %>
			    </tbody>
