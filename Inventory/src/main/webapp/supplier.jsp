		                    ...
		                    <div class="col-sm-12 offset-md-1 offset-lg-2 col-md-10 col-lg-8">
		                        <div class="card">
		                            <div class="card-body">
		                                ...
		                                <form class="row" action="supplier" method="post">
		                                	<input type="hidden" name = "id" value = "<%= suppliers.getId() > 0 ? suppliers.getId():""%>" >
		                                	<input type="hidden" name="action" value="<%= suppliers.getId() > 0 ? "update" : "create"%>">
		                                    
		                                    <div class="form-group col-sm-12 col-md-6 col-lg-6">
		                                    	<label class="">Name </label>
		                                        <input required type="text" class="form-control" name="suppliername" 
		                                        value="<%= suppliers.getSuppliersname() == null ? "": suppliers.getSuppliersname() %>" placeholder="Designation">
		                                        
		                                        <label class="">Phone</label>
		                                        <input required type="tel" class="form-control" name="phone" 
		                                        value="<%= suppliers.getPhone() == null ? "": suppliers.getPhone() %>" placeholder = "Price">
		                                    ...
		                                    <div class="form-group col-sm-12 col-md-6 col-lg-6">
		                                        ...
		                                        value="<%= suppliers.getAddress() == null ? "":suppliers.getAddress() %>">
		                                    </div>
