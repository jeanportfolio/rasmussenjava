		                    ...
		                    <div class="col-sm-12 offset-md-1 offset-lg-2 col-md-10 col-lg-8">
		                        <div class="card">
		                            <div class="card-body">
		                                ...
		                                <% Usersrole usersrole = (Usersrole)request.getAttribute("usersrole"); %>
		                                <form class="row" action="usersrole" method="post">
		                                	<input type="hidden" name = "id" value = "<%= usersrole.getId() > 0 ? usersrole.getId():""%>" >
		                                	<input type="hidden" name="action" value="<%= usersrole.getId() <= 0 ? "create" : "update"%>">
		                                    <div class="form-group col-sm-12 col-md-6 col-lg-6">
		                                    	<label class="">Title </label>
		                                        <input required type="text" class="form-control" name="title" 
		                                        value="<%= usersrole.getTitle() == null ? "": usersrole.getTitle()%>" placeholder="Title">
		                                        <label class="">Description </label>
		                                        <textarea rows="5" class="form-control" name="description" 
		                                        placeholder="Describe the Role"><%= usersrole.getDescription() == null ? "":usersrole.getDescription()%></textarea>
