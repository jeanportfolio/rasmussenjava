    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
			    ...
			    <% List<Userstatus> listuserstatus = (List<Userstatus>)request.getAttribute("listuserstatus");%>
			  		<% for(Userstatus userstatus : listuserstatus){ %>
			        <tr>
			            <td><%= userstatus.getTitle() %></td>
			            <td>
			            	<a class="btn" href="userstatus?action=update&id=<%= userstatus.getId()%>">Edit</a>
			            </td>
			        </tr>
			    <% } %>
			    </tbody>
